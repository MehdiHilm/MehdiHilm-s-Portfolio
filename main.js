...
function lineBreak() {
  ...
  if (window.innerWidth > 714 && window.innerWidth < 950) {
    title.innerHTML = ` Hello! I'm  
    <div class="underlined">
      Mehdi<span class="line"></span>
      Hilm.<span class="line"></span>
    </div> `;
  } else {
    title.innerHTML = ` Hello! <br> I'm  
    <div class="underlined">
    Mehdi<span class="line"></span> Hilm.<span class="line"></span>
    </div>`;
  }
}
